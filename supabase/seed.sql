...
INSERT INTO public.teacher_skills (teacher_id, subject, grade_min, grade_max) VALUES
  ...
  ('66666666-6666-6666-6666-666666666666', '国語', 7, 9),
  ('66666666-6666-6666-6666-666666666666', '現代文', 10, 12),
  ('77777777-7777-7777-7777-777777777777', '理科', 7, 9),
  ('77777777-7777-7777-7777-777777777777', '物理', 10, 12)
...
INSERT INTO public.student_subjects (student_id, subject) VALUES
  ...
  ('a3333333-3333-3333-3333-333333333333', '数I・II・A・B'),
  ('a3333333-3333-3333-3333-333333333333', '英語'),
  ('a3333333-3333-3333-3333-333333333333', '物理'),
  ('a4444444-4444-4444-4444-444444444444', '数I・II・A・B'),
  ('a4444444-4444-4444-4444-444444444444', '英語'),
  ('a5555555-5555-5555-5555-555555555555', '数Ⅲ'),
  ('a5555555-5555-5555-5555-555555555555', '物理'),
  ('a6666666-6666-6666-6666-666666666666', '数学'),
